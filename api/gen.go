...
type GetReposParams struct {
	// Language The language used in the repo
	Language *string `form:"language,omitempty" json:"language,omitempty"`

	// License The license of the repos that we want to get
...
type ServerInterface interface {
	...
	// (GET /repos)
	GetRepos(w http.ResponseWriter, r *http.Request, params GetReposParams)
}
...
func (siw *ServerInterfaceWrapper) GetRepos(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "license", r.URL.Query(), &params.License)
	if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetRepos(w, r, params)
	}))
